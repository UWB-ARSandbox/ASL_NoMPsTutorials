...
namespace Mps
{
    public class AR_CSS451_Mp2_XformControl_Shadows : MonoBehaviour
    {
        public Toggle T, R, S;
        public AR_CSS451_Mp2_SliderWithEcho_Shadows X, Y, Z;
        ...
        void SetToScaling(bool v)
        {
            ...
            X.InitSliderRange(0.01f, 10, s.x);
            Y.InitSliderRange(0.01f, 10, s.y);
            Z.InitSliderRange(0.01f, 10, s.z);
        }
