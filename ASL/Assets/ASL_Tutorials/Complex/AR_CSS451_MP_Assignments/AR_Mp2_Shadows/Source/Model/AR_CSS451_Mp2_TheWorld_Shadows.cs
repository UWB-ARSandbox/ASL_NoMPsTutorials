...
namespace Mps
{
    public partial class AR_CSS451_Mp2_TheWorld_Shadows : MonoBehaviour
    {
        ...
        public AR_CSS451_Mp2_XformControl_Shadows mXform;
        ...
        private void SetObjectSelection(GameObject g)
        {
            ...
            if (mSelected?.GetComponent<ASL.ASLObject>() != null)
            {
                mOrgObjColor = g.GetComponent<AR_CSS451_Mp2_ColorSupport_Shadows>().m_OrgObjColor; // save a copy of original color
